    ...
    <div class="player">
      ...
      <div class="player-info">
        ...
        <div class="track-info-text mt-4">
          <transition name="slide-fade" mode="out-in">
            <span :key="current.name == 'backup' ? track.title : metadata.title"  class="track-title">{{ current.name == 'backup' ? track.title : metadata.title }}</span>
          </transition>
          <transition name="slide-fade" mode="out-in">
            <span :key="current.name == 'backup' ? track.artist : metadata.artist" class="track-artist">{{
  ...
  export default {
    ...
    data() {
      return {
        ...
        //     url: "https://jp-broadcaster.cloudsdaleradio.com/cloudsdaleradio320.mp3",
        //   },
        //   {
